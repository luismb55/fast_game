package 
{
	...
	public class Zone
	{
		...
		public function Zone(zoneName:String, zoneData:MovieClip, zoneVSpeed:Number = 10.0) 
		{
		...
		public function AddTransitionZone(zoneA:String, zoneB:String):void
		{
			...
			if (zoneA != zoneB) {
				...
				for (var i:int = 0; i < zoneData.numChildren; i++) {
					zoneData.getChildAt(i).y += zoneTransition.height;
				}
		...
		public function get heightWithoutTransition():Number
		{
			return data.height - zoneTransition.height;
		}
